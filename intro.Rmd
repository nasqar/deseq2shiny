...
- If samples contain **replicates**, they should be denoted by **underscore** and the replicate number (see **figure 2**)

- If no replicates, then select **No replicates** option to help set the default experiment conditions for the next step
...
- For a sample file, download and view <a href="www/sampleCounts.csv" target="_blank">this</a> file
